...
-(void)CreatView{
    ...
    [Engine huoQuShiMingRenZhengZiLiaosuccess:^(NSDictionary *dic) {
        NSDictionary * contentDic =[dic objectForKey:@"content"];
        
        nameText.text=[ToolClass isString:[NSString stringWithFormat:@"%@",[contentDic objectForKey:@"real_name"]]];
        nameText2.text=[ToolClass isString:[NSString stringWithFormat:@"%@",[contentDic objectForKey:@"id_card"]]];

        [_button1 sd_setBackgroundImageWithURL:[NSURL URLWithString:[ToolClass isString:[NSString stringWithFormat:@"%@",[contentDic objectForKey:@"id_card_front"]]]] forState:0];
     
        [_lastBtn sd_setBackgroundImageWithURL:[NSURL URLWithString:[ToolClass isString:[NSString stringWithFormat:@"%@",[contentDic objectForKey:@"id_card_back"]]]] forState:0];
    } error:^(NSError *error) {
