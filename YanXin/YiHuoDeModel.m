...
-(id)initWithMingXiDic:(NSDictionary*)dic{
    ...
    if (self) {
       ...
       */
        ...
        _extractMoney =[ToolClass isString:[NSString stringWithFormat:@"%@",[dic objectForKey:@"extract_money"]]];
        _timeName =[ToolClass isString:[NSString stringWithFormat:@"%@",[dic objectForKey:@"extract_time"]]];
        _alipayName =[ToolClass isString:[NSString stringWithFormat:@"%@",[dic objectForKey:@"alipay_name"]]];
       
         NSString * stype=[ToolClass isString:[NSString stringWithFormat:@"%@",[dic objectForKey:@"remit_status"]]];
