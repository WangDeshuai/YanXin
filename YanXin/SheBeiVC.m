...
-(void)InteNextDataPage:(NSString*)page{
    //3演出公司，4演出设备，5演出场地
    [Engine ChaXunYanShangPage:page Type:@"4" PageSize:@"10" success:^(NSDictionary *dic) {
...
-(void)CreatTabelView{
    if (!_tableView) {
        _tableView=[[UITableView alloc]initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHight-64) style:UITableViewStylePlain];
    }
