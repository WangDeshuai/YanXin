...
- (void)viewDidLoad {
   ...
   // _bgScroller.contentSize=CGSizeMake(KUAN, GAO+200);
   ...
   // [self textFoundColor:xiangXiLable];
    ...
    phoneLabel.text=@"联系方式:";//[NSString stringWithFormat:@"联系方式:  %@",_model.phoneLabel];
...
//    .widthIs(imageview.image.size.width/2);
    ...
    //  NSLog(@">>>宽%f>>>高%f", imageview.image.size.width,imageview.image.size.height );
